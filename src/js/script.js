...
// Initialize Feather icons
        ...
        document.getElementById('emailContactForm').addEventListener('submit', function(e) {
            ...
            const mailtoLink = `mailto:tegarroofi2@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(emailBody)}`;
        ...
        document.getElementById('whatsappContactForm').addEventListener('submit', function(e) {
            ...
            const whatsappMessage = `Hi Tegar! 👋\n\nName: ${name}\nPhone: +62${phone}\n\nMessage:\n${message}`;
            const whatsappNumber = '6285890644363'; // Nomor WhatsApp yang sudah benar
